...
import { AdminPickupAddressType } from 'src/pages/Admin/types';
import { userDataInitialValues } from 'src/shared/common/values';


type SubState = {
  data: AdminPickupAddressType[],
  showModal: (values: AdminPickupAddressType) => void,
    ...
    },
    {
      ...
      options: {
        customBodyRender: (value: any, tableMeta: MUIDataTableMeta) => {
          ...
          return (
            <>
              {userDataInitialValues.permissions.includes('edit pickupaddresses') && (
              ...
              {userDataInitialValues.permissions.includes('destroy pickupaddresses') && (
                <IonButton style={buttonStyle}
                           slot="icon-only" fill="clear" size="small" color="gray50"
