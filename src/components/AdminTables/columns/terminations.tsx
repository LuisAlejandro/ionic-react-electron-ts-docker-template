...
import { AdminTerminationType } from 'src/pages/Admin/types';
import { userDataInitialValues } from 'src/shared/common/values';


type SubState = {
  data: AdminTerminationType[],
  showModal: (values: AdminTerminationType) => void,
...
const generateColumns = (props: SubState) => {
  ...
  const columns: MUIDataTableColumn[] = [
    {
      name: "name",
      label: "Nombre de la Terminación",
    },
    {
      name: "alias",
      label: "Alias",
    ...
    },
    {
      ...
      options: {
        customBodyRender: (value: any, tableMeta: MUIDataTableMeta) => {
          ...
          return (
            <>
              {userDataInitialValues.permissions.includes('edit terminations') && (
              ...
              {userDataInitialValues.permissions.includes('destroy terminations') && (
                <IonButton style={buttonStyle}
                           slot="icon-only" fill="clear" size="small" color="gray50"
