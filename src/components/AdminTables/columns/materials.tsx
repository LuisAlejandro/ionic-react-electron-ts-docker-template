...
import { AdminMaterialType } from 'src/pages/Admin/types';
import { userDataInitialValues } from 'src/shared/common/values';


type SubState = {
  data: AdminMaterialType[],
  showModal: (values: AdminMaterialType) => void,
    ...
    },
    {
      ...
      options: {
        customBodyRender: (value: any, tableMeta: MUIDataTableMeta) => {
          ...
          return (
            <>
              {userDataInitialValues.permissions.includes('edit materials') && (
              ...
              {userDataInitialValues.permissions.includes('destroy materials') && (
                <IonButton style={buttonStyle}
                           slot="icon-only" fill="clear" size="small" color="gray50"
