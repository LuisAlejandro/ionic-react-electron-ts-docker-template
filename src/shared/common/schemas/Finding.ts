...
// const findingDetailsSchema = yup
//   .object({
//     type: yup
//       .string()
//       .required()
...
const findingsSchema = yup
  .array(findingDetailsSchema)
  .max(10, 'Solo puede agregarse una cantidad máxima de 10 hallazgos')
  .label("Hallazgos")
  .default([]);


export { findingsSchema, findingDetailsSchema };
